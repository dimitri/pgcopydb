BEGIN; -- {"xid":492,"lsn":"0/24DDF98","timestamp":"2024-06-28 03:18:40.300405+0000","commit_lsn":"0/24DE418"}
...
COMMIT; -- {"xid":492,"lsn":"0/24DE418","timestamp":"2024-06-28 03:18:40.300405+0000"}
BEGIN; -- {"xid":493,"lsn":"0/24DE418","timestamp":"2024-06-28 03:18:40.300691+0000","commit_lsn":"0/24DF4E8"}
...
COMMIT; -- {"xid":493,"lsn":"0/24DF4E8","timestamp":"2024-06-28 03:18:40.300691+0000"}
BEGIN; -- {"xid":494,"lsn":"0/24DF6A8","timestamp":"2024-06-28 03:18:40.300716+0000","commit_lsn":"0/24DF7B8"}
PREPARE 92a66af4 AS DELETE FROM public.payment_p2022_06 WHERE (payment_id = $1 and customer_id = $2 and staff_id = $3 and rental_id = $4 and amount = $5 and payment_date = $6);
EXECUTE 92a66af4["32099","291","1","16050","5.99","2022-06-01 00:00:00+00"];
PREPARE ae2368b0 AS DELETE FROM public.rental WHERE (rental_id = $1);
EXECUTE ae2368b0["16050"];
COMMIT; -- {"xid":494,"lsn":"0/24DF7B8","timestamp":"2024-06-28 03:18:40.300716+0000"}
BEGIN; -- {"xid":495,"lsn":"0/24DF7B8","timestamp":"2024-06-28 03:18:40.300791+0000","commit_lsn":"0/24DFD38"}
PREPARE b44633db AS UPDATE public.payment_p2022_02 SET amount = $1 WHERE payment_id = $2 and customer_id = $3 and staff_id = $4 and rental_id = $5 and amount = $6 and payment_date = $7;
...
COMMIT; -- {"xid":495,"lsn":"0/24DFD38","timestamp":"2024-06-28 03:18:40.300791+0000"}
BEGIN; -- {"xid":496,"lsn":"0/24DFD38","timestamp":"2024-06-28 03:18:40.300893+0000","commit_lsn":"0/24DFEE8"}
...
EXECUTE 65b94c7d["Warner","Hudson","45","hartmann1448@ratkehaley.com","25","true","fay.kub","8cb2237d0679ca88db6464eac60da96345513964","2024-06-28 03:18:40.124473+00",null,"1"];
COMMIT; -- {"xid":496,"lsn":"0/24DFEE8","timestamp":"2024-06-28 03:18:40.300893+0000"}
BEGIN; -- {"xid":497,"lsn":"0/24DFEE8","timestamp":"2024-06-28 03:18:40.300926+0000","commit_lsn":"0/24DFFC0"}
PREPARE 4835081e AS INSERT INTO public."""dqname""" (id) overriding system value VALUES ($1);
EXECUTE 4835081e["1"];
COMMIT; -- {"xid":497,"lsn":"0/24DFFC0","timestamp":"2024-06-28 03:18:40.300926+0000"}
BEGIN; -- {"xid":498,"lsn":"0/24DFFC0","timestamp":"2024-06-28 03:18:40.300958+0000","commit_lsn":"0/24E00F8"}
PREPARE 7a201c42 AS INSERT INTO public.identifer_as_column ("time") overriding system value VALUES ($1);
EXECUTE 7a201c42["1"];
PREPARE e622e801 AS DELETE FROM public.identifer_as_column WHERE ("time" = $1);
EXECUTE e622e801["1"];
COMMIT; -- {"xid":498,"lsn":"0/24E00F8","timestamp":"2024-06-28 03:18:40.300958+0000"}
BEGIN; -- {"xid":499,"lsn":"0/24E00F8","timestamp":"2024-06-28 03:18:40.301008+0000","commit_lsn":"0/24E01B0"}
PREPARE 15aec07e AS INSERT INTO public.t_bit_types (id, a, b) overriding system value VALUES ($1, $2, $3);
EXECUTE 15aec07e["2","100","101"];
COMMIT; -- {"xid":499,"lsn":"0/24E01B0","timestamp":"2024-06-28 03:18:40.301008+0000"}
-- KEEPALIVE {"lsn":"0/24E01B0","timestamp":"2024-06-28 03:18:40.301014+0000"}
-- ENDPOS {"lsn":"0/24E01B0"}
